# LAB-OOP-1-2026
# Repositori Tugas Praktikum Object Oriented Programming
...
2. **Clone** repositori hasil **fork** anda
   ...
   git clone https://github.com/YOUR_USERNAME/LAB_OOP_11_2026.git
...
5. Setiap membuat _file_ atau melakukan perubahan, lakukan proses **commit** dengan pesan yang deskriptif
   ...
   # atau
   git add "Praktikum n/NIM/FileJavaYangBerubahAtauDitambahkan.java" #perintah ini memilih file tertentu
...
6. Setelah asistensi dan tugas anda disetujui, **push** seluruh _file_ jawaban yang telah anda buat
   ...
   #6. Tuliskan note untuk token anda (ex: Token for LAB-OOP-1-2026)
